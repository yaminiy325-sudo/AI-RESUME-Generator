...
GOOGLE_API_KEY = st.sidebar.textinput("GOOGLE_API_KEY",type="password")
GROQ_API_KEY = st.sidebar.textinput("GROQ_API_KEY",type="password")
TAVILY_API_KEY = st.sidebar.textinput("TAVILY_API_KEY",type="password")
#===========model building============
